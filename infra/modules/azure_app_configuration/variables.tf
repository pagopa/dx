...
variable "diagnostic_settings" {
  ...
  description = "Diagnostic settings for App Configuration logs and metrics. When enabled, sends diagnostics to Log Analytics workspace and/or Storage Account."
  default = {
    enabled                    = false
