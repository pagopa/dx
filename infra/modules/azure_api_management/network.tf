...
resource "azurerm_private_dns_a_record" "apim_azure_api_net" {
  ...
  ttl                 = 3600
  records             = local.use_case_features.private_endpoint ? [azurerm_private_endpoint.apim_pep[0].ip_configuration[0].private_ip_addresses] : azurerm_api_management.this.private_ip_addresses
