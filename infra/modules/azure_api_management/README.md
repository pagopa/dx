...
| <a name="input_application_insights"></a> [application\_insights](#input\_application\_insights) | Application Insights integration. The connection string used to push data | <pre>object({<br/>    enabled           = bool<br/>    connection_string = string<br/>  })</pre> | <pre>{<br/>  "connection_string": null,<br/>  "enabled": false<br/>}</pre> | no |
