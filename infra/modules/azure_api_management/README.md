...
| <a name="input_products"></a> [products](#input\_products) | List of products to create | <pre>list(object({<br>    id           = string<br>    display_name = string<br>    description  = string<br>    groups       = optional(list(string))<br>    xml_policy   = optional(string)<br>  }))</pre> | `[]` | no |
