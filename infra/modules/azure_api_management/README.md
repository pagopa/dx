  ...
  products = [
    {
      ...
      description  = "Access to all premium APIs"
      groups       = ["admins", "developers"]
      xml_policy   = "<policies>...</policies>"
    },
  ]
  apis = [
    {
...
| Name | Description |
|------|-------------|
| <a name="output_api_ids"></a> [api\_ids](#output\_api\_ids) | APIs |
