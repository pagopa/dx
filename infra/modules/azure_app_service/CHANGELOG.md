...
- Address App Service Trivy findings ([#2195](https://github.com/pagopa/dx/pull/2195))
...
- 4802442: Drop Node.js 18 and 20 support and add Node.js 24. The `node_version` variable now accepts 22 and 24 only, with a new default of 22.
