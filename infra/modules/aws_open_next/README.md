...
| <a name="input_image_optimizer"></a> [image\_optimizer](#input\_image\_optimizer) | The image optimizer lambda function configuration. | <pre>object({<br/>    timeout               = optional(number, 30)<br/>    memory_size           = optional(number, 512)<br/>    handler               = optional(string, "index.handler")<br/>    environment_variables = optional(map(string), {})<br/>  })</pre> | <pre>{<br/>  "environment_variables": {},<br/>  "handler": "index.handler",<br/>  "memory_size": 512,<br/>  "timeout": 30<br/>}</pre> | no |
...
| <a name="input_server"></a> [server](#input\_server) | The server lambda function configuration. | <pre>object({<br/>    timeout               = optional(number, 30)<br/>    memory_size           = optional(number, 512)<br/>    handler               = optional(string, "index.handler")<br/>    environment_variables = optional(map(string), {})<br/>  })</pre> | <pre>{<br/>  "environment_variables": {},<br/>  "handler": "index.handler",<br/>  "memory_size": 512,<br/>  "timeout": 30<br/>}</pre> | no |
| <a name="input_tags"></a> [tags](#input\_tags) | Resources tags | `map(any)` | n/a | yes |
| <a name="input_vpc"></a> [vpc](#input\_vpc) | The VPC used to deploy the lambda functions in. Configure this only when you want the lambda to access private resources contained in the VPC. | <pre>object({<br/>    id              = string<br/>    private_subnets = list(string)<br/>  })</pre> | n/a | yes |
