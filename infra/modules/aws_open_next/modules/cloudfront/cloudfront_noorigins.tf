...
#   publish = true
#   code    = templatefile("${path.module}/cloudfront_functions/router/index.js", {PRODUCTION_FUNCTION_URL = var.origins.server_function.url})
...
#   # Mock Origin
#   origin {
#     domain_name              = "placeholder.mock.dev"
#     origin_id                = "${local.app_prefix}-mock-origin-${local.app_suffix}"
