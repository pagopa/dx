...
variable "memory_size" {
  type        = number
  description = "The amount of memory available to the function at runtime in MB. The default is 256 MB. The maximum is 10240 MB."
  default     = 256
...
variable "timeout" {
  type        = number
  description = "The maximum execution time for the function. The default is 900 seconds. The maximum is 900 seconds."
  default     = 900
