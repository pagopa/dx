...
module "cloudfront" {
  ...
  custom_domain = {
    domain_name     = var.custom_domain.domain_name != null ? var.custom_domain.domain_name : null
    acm_certificate_arn = var.custom_domain.domain_name != null ? var.custom_domain.acm_certificate_arn : null
  }
