output "common_resource_group_name" {
  ...
  value       = data.terraform_remote_state.core.outputs.common_resource_group_name
}

output "common_resource_group_id" {
  description = "The ID of the common resource group."
  value       = data.terraform_remote_state.core.outputs.common_resource_group_id
}

output "network_resource_group_name" {
  description = "The name of the network resource group."
  value       = data.terraform_remote_state.core.outputs.network_resource_group_name
}

output "network_resource_group_id" {
  description = "The ID of the network resource group."
  value       = data.terraform_remote_state.core.outputs.network_resource_group_id
}


output "test_resource_group_name" {
  description = "The name of the test resource group (null if testing is disabled)."
  value       = data.terraform_remote_state.core.outputs.test_resource_group_name
}
...
output "github_runner" {
  ...
  value = {
    environment_id      = data.terraform_remote_state.core.outputs.github_runner.environment_id
    resource_group_name = data.terraform_remote_state.core.outputs.github_runner.resource_group_name
    subnet_id           = data.terraform_remote_state.core.outputs.github_runner.subnet_id
  }
}
...
output "common_vnet" {
  ...
  value = {
    name = data.terraform_remote_state.core.outputs.common_vnet.name
    id   = data.terraform_remote_state.core.outputs.common_vnet.id
  }
}
...
output "common_pep_snet" {
  ...
  value = {
    name = data.terraform_remote_state.core.outputs.common_pep_snet.name
    id   = data.terraform_remote_state.core.outputs.common_pep_snet.id
  }
}

output "common_nat_gateways" {
  description = "A list of NAT gateways, including their IDs and names."
  value       = data.terraform_remote_state.core.outputs.common_nat_gateways
}
...
output "common_key_vault" {
  ...
  value = {
    name                = data.terraform_remote_state.core.outputs.common_key_vault.name
    id                  = data.terraform_remote_state.core.outputs.common_key_vault.id
    resource_group_name = data.terraform_remote_state.core.outputs.common_key_vault.resource_group_name
  }
}
...
output "common_log_analytics_workspace" {
  ...
  value = {
    id           = data.terraform_remote_state.core.outputs.common_log_analytics.id
    name         = data.terraform_remote_state.core.outputs.common_log_analytics.name
    workspace_id = data.terraform_remote_state.core.outputs.common_log_analytics.workspace_id
  }
}
