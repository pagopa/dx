...
| <a name="input_authorized_principal_ids"></a> [authorized\_principal\_ids](#input\_authorized\_principal\_ids) | A list of principal IDs (users, groups, or managed identities) to be granted specific permissions on the Cosmos DB account. | `list(string)` | `[]` | no |
