...
| <a name="input_target_service"></a> [target\_service](#input\_target\_service) | n/a | <pre>object({<br/>    app_service = optional(object({<br/>      id   = optional(string)<br/>      name = string<br/>    }))<br/>    function_app = optional(object({<br/>      id   = optional(string)<br/>      name = string<br/>    }))<br/>  })</pre> | n/a | yes |
