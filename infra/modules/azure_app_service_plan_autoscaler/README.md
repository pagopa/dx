...
| <a name="input_target_services"></a> [target\_services](#input\_target\_services) | An object containing two optional lists: one for App Service names and one for Function App names. | <pre>object({<br/>    app_service_name  = optional(list(string))<br/>    function_app_name = optional(list(string))<br/>  })</pre> | n/a | yes |
