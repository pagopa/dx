...
# trivy:ignore:AZU-0057 Storage diagnostics destinations are owned by the consumer
# trivy:ignore:AZU-0058 Cross-region replication is a consumer workload decision; runtime storage uses ZRS
