...
| <a name="input_node_version"></a> [node\_version](#input\_node\_version) | The version of Node.js to use for the Function App runtime. Supported versions: 22, 24. | `number` | `22` | no |
