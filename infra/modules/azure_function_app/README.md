...
| <a name="input_application_insights_key"></a> [application\_insights\_key](#input\_application\_insights\_key) | (Optional) Application Insights instrumentation key. Do not use if you are using a connection string, which is instead preferrable as instrumentation key will be deprecated on March 31, 2025 | `string` | `null` | no |
...
| <a name="input_has_durable_functions"></a> [has\_durable\_functions](#input\_has\_durable\_functions) | (Optional) Enable if the Function App hosts Durable Functions | `bool` | `false` | no |
...
| <a name="output_storage_account_durable"></a> [storage\_account\_durable](#output\_storage\_account\_durable) | n/a |
