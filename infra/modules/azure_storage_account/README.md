...
| <a name="input_override_infrastructure_encryption"></a> [override\_infrastructure\_encryption](#input\_override\_infrastructure\_encryption) | Override to disable infrastructure encryption. Useful for audit use case when infrastructure encryption needs to be disabled despite the default configuration. | `bool` | `false` | no |
