...
| <a name="input_private_dns_zone_ids"></a> [private\_dns\_zone\_ids](#input\_private\_dns\_zone\_ids) | Override IDs for private DNS zones. If not provided, zones will be looked up in private\_dns\_zone\_resource\_group\_name. Use this to reference DNS zones in different subscriptions. | <pre>object({<br/>    blob  = optional(string)<br/>    file  = optional(string)<br/>    queue = optional(string)<br/>    table = optional(string)<br/>  })</pre> | `null` | no |
