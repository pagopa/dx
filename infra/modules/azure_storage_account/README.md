...
| <a name="input_audit_retention_days"></a> [audit_retention_days](#input_audit_retention_days)                                                 | Number of days to retain audit/archive logs before automatic deletion. PagoPA standard is 365 days (12 months). Must be between 90 and 3650 days. Only applies to 'audit' and 'archive' use cases.                                                                                                                                                                                                                             | `number`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `1095`                                                                                                                                                                                                                                                                                   |    no    |
