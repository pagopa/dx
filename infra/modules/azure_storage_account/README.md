...
The two values must either both be set or both be unset. Existing public-only configurations that leave both unset create no private endpoint resources.
