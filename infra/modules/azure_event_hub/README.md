...
| <a name="input_allowed_sources"></a> [allowed\_sources](#input\_allowed\_sources) | List of allowed sources (subnets and ip masks) | <pre>list(object({<br>    subnet_ids = list(string)<br>    ips        = list(string)<br>  }))</pre> | `[]` | no |
