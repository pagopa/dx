...
| Name                                                               | Version |
| ------------------------------------------------------------------ | ------- |
| <a name="requirement_azurerm"></a> [azurerm](#requirement_azurerm) | ~> 4.60 |
...
| Name                                                                                                                                                                               | Description |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| <a name="output_azurerm_managed_redis_access_policy_assignment"></a> [azurerm\_managed\_redis\_access\_policy\_assignment](#output_azurerm_managed_redis_access_policy_assignment) | n/a         |
