locals {
  norm_blobs = [
    for blob in var.storage_blob : {
      ...
      storage_account_id            = provider::azurerm::normalise_resource_id("/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/${blob.resource_group_name}/providers/Microsoft.Storage/storageAccounts/${blob.storage_account_name}")
  ...
  norm_tables = [
    for table in var.storage_table : {
      ...
      storage_account_id        = provider::azurerm::normalise_resource_id("/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/${table.resource_group_name}/providers/Microsoft.Storage/storageAccounts/${table.storage_account_name}")
  ...
  norm_queues = [
    for queue in var.storage_queue : {
      ...
      storage_account_id        = provider::azurerm::normalise_resource_id("/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/${queue.resource_group_name}/providers/Microsoft.Storage/storageAccounts/${queue.storage_account_name}")
