...
|------|-------------|------|---------|:--------:|
| <a name="input_application_insights"></a> [application\_insights](#input\_application\_insights) | A list of Application Insights role assignments. Assigns the Monitoring Metrics Publisher role, which allows publishing custom metrics. | <pre>list(object({<br/>    name                = string<br/>    resource_group_name = string<br/>    description         = string<br/>  }))</pre> | `[]` | no |
