...
| <a name="input_function_settings"></a> [function\_settings](#input\_function\_settings) | n/a | <pre>object({<br/>    key_vault_name                           = string<br/>    application_insights_connection_string   = string<br/>    application_insights_sampling_percentage = optional(number, 5)<br/>    has_durable_functions                    = optional(bool, false)<br/>    subnet_pep_id                            = string<br/>    private_dns_zone_resource_group_id       = string<br/>    action_group_ids                         = optional(set(string), [])<br/>    concurrent_requests                      = optional(number, 1000)<br/>  })</pre> | `null` | no |
