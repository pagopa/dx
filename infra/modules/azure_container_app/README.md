...
|------|-------------|------|---------|:--------:|
| <a name="input_container_app_environment"></a> [container\_app\_environment](#input\_container\_app\_environment) | The container app environment to deploy the container app to. | <pre>object({<br/>    id = string<br/>    private_dns_zone = object({<br/>      name                = string<br/>      resource_group_name = string<br/>    })<br/>    private_endpoint_ip = optional(string, "")<br/>  })</pre> | n/a | yes |
