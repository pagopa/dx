...
|------|-------------|------|---------|:--------:|
| <a name="input_container_app_environment"></a> [container\_app\_environment](#input\_container\_app\_environment) | The container app environment to deploy the container app to. | <pre>object({<br/>    id                                   = string<br/>    private_dns_zone_resource_group_name = string<br/>    private_endpoint_ip                  = optional(string, "")<br/>  })</pre> | n/a | yes |
