...
run "validate_github_id_infra" {
  ...
  assert {
    ...
    error_message = "The Infra CD managed identity can't manage private networking at the DNS resource group scope"
  }

  assert {
    condition     = azurerm_role_assignment.infra_cd_rg_nat_gw_private_networking != null
