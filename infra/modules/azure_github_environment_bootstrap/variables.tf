...
variable "repository" {
  ...
  description = "Information about this repository. Set the configure option to false only if you already setup the repository for another cloud service provider or environment in the same project."
}
