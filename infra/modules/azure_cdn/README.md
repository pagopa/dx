...
| <a name="input_origin_group"></a> [origin\_group](#input\_origin\_group) | Origin group configuration | <pre>object({<br/>    health_probe_path = optional(string, "/")<br/>    request_type      = optional(string, "HEAD")<br/>  })</pre> | n/a | yes |
