...
|------|-------------|------|---------|:--------:|
| <a name="input_administrator_credentials"></a> [administrator\_credentials](#input\_administrator\_credentials) | Flexible PostgreSql server administrator credentials | <pre>object({<br/>    name     = string<br/>    password = string<br/>  })</pre> | n/a | yes |
...
| <a name="input_auto_grow_enabled"></a> [auto\_grow\_enabled](#input\_auto\_grow\_enabled) | (Optional) Enabled auto grow for PostgreSQL Flexible Server backups. | `bool` | `false` | no |
...
| <a name="input_geo_redundant_backup_enabled"></a> [geo\_redundant\_backup\_enabled](#input\_geo\_redundant\_backup\_enabled) | (Optional) Enables geo redundancy for PostgreSQL Flexible Server backups. | `bool` | `false` | no |
| <a name="input_high_availability_enabled"></a> [high\_availability\_enabled](#input\_high\_availability\_enabled) | (Optional) Enables high availability flag for PostgreSQL Flexible Server. | `bool` | `false` | no |
...
| <a name="input_replica_enabled"></a> [replica\_enabled](#input\_replica\_enabled) | (Optional) Enables replica for PostgreSQL Flexible Server. | `bool` | `false` | no |
