...
| <a name="input_replica_location"></a> [replica\_location](#input\_replica\_location) | The location where the replica PostgreSQL Flexible Server should be created. Defaults to the same as the primary server. | `string` | `null` | no |
