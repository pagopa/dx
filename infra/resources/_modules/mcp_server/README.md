...
| [aws_api_gateway_integration.bedrock_ask](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_integration) | resource |
| [aws_api_gateway_integration.bedrock_search](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_integration) | resource |
...
| [aws_api_gateway_method.search](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_method) | resource |
...
| <a name="input_bedrock_model_id"></a> [bedrock\_model\_id](#input\_bedrock\_model\_id) | The model ID of the Amazon Bedrock model to use for generating responses. | `string` | `"amazon.nova-2-lite-v1:0"` | no |
