...
| <a name="input_bedrock_model_id"></a> [bedrock\_model\_id](#input\_bedrock\_model\_id) | The ARN of the Amazon Bedrock model to use for generating responses. | `string` | `"amazon.nova-2-lite-v1:0"` | no |
