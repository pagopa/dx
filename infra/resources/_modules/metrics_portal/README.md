...
| <a name="input_import_job_image"></a> [import\_job\_image](#input\_import\_job\_image) | OCI image URI for the import job container, built from the dx-metrics Dockerfile.import (e.g., 'ghcr.io/pagopa/dx-metrics-import:latest'). | `string` | n/a | yes |
