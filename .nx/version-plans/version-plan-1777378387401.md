...
The module also accepts `custom_role_definition_ids`, allowing consumers to pass the custom role IDs exported by core infrastructure and assign merged roles by ID instead of by name.
