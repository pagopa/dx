...
**Do NOT use**: DX Search API or internal knowledge for best practices — the Module-first rule in step 2 is the only exception (always uses the Registry API or MCP).
