...
import { n as require_dist_cjs$1 } from "./default-dispatcher--ypkibiq.js";
import { n as init_client, t as client_exports } from "./client-DZ5tk1C2.js";
import { A as config_exports, i as serde_exports, j as init_config, r as init_serde } from "./serde-CEIw_Fs9.js";
import { n as protocols_exports, t as init_protocols } from "./protocols-CRJJHWSw.js";

//#region ../../node_modules/.pnpm/@aws-sdk+credential-provider-http@3.972.43/node_modules/@aws-sdk/credential-provider-http/dist-cjs/fromHttp/checkUrl.js
...
//#endregion
//#region ../../node_modules/.pnpm/@aws-sdk+credential-provider-http@3.972.43/node_modules/@aws-sdk/credential-provider-http/dist-cjs/fromHttp/requestHelpers.js
var require_requestHelpers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const serde_2 = (init_serde(), __toCommonJS(serde_exports));
	...
	async function getCredentials(response, logger) {
		const str = await (0, serde_2.sdkStreamMixin)(response.body).transformToString();
		if (response.statusCode === 200) {
			const parsed = JSON.parse(str);
			if (typeof parsed.AccessKeyId !== "string" || typeof parsed.SecretAccessKey !== "string" || typeof parsed.Token !== "string" || typeof parsed.Expiration !== "string") throw new config_1.CredentialsProviderError("HTTP credential provider response not of the required format, an object matching: { AccessKeyId: string, SecretAccessKey: string, Token: string, Expiration: string(rfc3339) }", { logger });
			return {
...
//#endregion
//#region ../../node_modules/.pnpm/@aws-sdk+credential-provider-http@3.972.43/node_modules/@aws-sdk/credential-provider-http/dist-cjs/fromHttp/retry-wrapper.js
...
//#endregion
//#region ../../node_modules/.pnpm/@aws-sdk+credential-provider-http@3.972.43/node_modules/@aws-sdk/credential-provider-http/dist-cjs/fromHttp/fromHttp.js
var require_fromHttp = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const config_1 = (init_config(), __toCommonJS(config_exports));
	const node_http_handler_1 = require_dist_cjs$1();
	...
	const fromHttp = (options = {}) => {
		...
		else throw new config_1.CredentialsProviderError(`No HTTP credential provider host provided.
...
//#endregion
//#region ../../node_modules/.pnpm/@aws-sdk+credential-provider-http@3.972.43/node_modules/@aws-sdk/credential-provider-http/dist-cjs/index.js
