...
describe("release-publish executor", () => {
  ...
  it("pushes the image references derived from metadata tags when configured", async () => {
    ...
    const context: DockerPublishExecutorContext = {
      projectGraph: {
        nodes: {
          sample: {
            data: {
    ...
    await releasePublishExecutor({ quiet: true }, context);
    ...
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:1.2.3 ghcr.io/pagopa/example:1.2",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:1.2.3 ghcr.io/pagopa/example:1",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:1.2.3 ghcr.io/pagopa/example:sha-1234567",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:1.2.3 ghcr.io/pagopa/example:v1.2.3",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).not.toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:1.2.3 ghcr.io/pagopa/example:latest",
      expect.any(Object),
    );
  });

  it("ignores unrelated project tags on head when deriving publish refs locally", async () => {
    fsMocks.readFileSync.mockImplementation(() => "ghcr.io/pagopa/example:0.12.72");
    ...
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:0.12.72 ghcr.io/pagopa/example:0.12",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:0.12.72 ghcr.io/pagopa/example:0",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:0.12.72 ghcr.io/pagopa/example:sha-9457618",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).not.toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:0.12.72 ghcr.io/pagopa/example:0.1.14",
      expect.any(Object),
    );
    expect(childProcessMocks.execSync).not.toHaveBeenCalledWith(
      "docker tag ghcr.io/pagopa/example:0.12.72 ghcr.io/pagopa/example:docker",
      expect.any(Object),
    );
  });
