...
import type { DockerBuildExecutorInput } from "../schema.ts";

import executor from "../docker-build.ts";
...
} satisfies DockerBuildExecutorInput;
...
describe("docker-build executor", () => {
  ...
  it("delegates to runDockerCommand in build mode, applying the platform default", async () => {
