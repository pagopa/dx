...
| **Retail candidate to evaluate**    | Private Endpoints                                                                                            | Retail Prices API   | Only useful if SaveMoney keeps an orphan/disconnected signal that AZQR/AOR does not already cover well. |
