...
describe("Resource Type Detection", () => {
  it("should detect Virtual Machine resource type", () => {
    const resourceType = "microsoft.compute/virtualmachines";
    expect(resourceType.toLowerCase()).toBe(
      "microsoft.compute/virtualmachines",
    );
  });

  it("should detect App Service Plan resource type", () => {
    const resourceType = "Microsoft.Web/serverFarms";
    expect(resourceType.toLowerCase()).toBe("microsoft.web/serverfarms");
  });

  it("should detect Storage Account resource type", () => {
  ...
  it("should detect Managed Disk resource type", () => {
    const resourceType = "Microsoft.Compute/disks";
    expect(resourceType.toLowerCase()).toBe("microsoft.compute/disks");
  });

  it("should detect Network Interface resource type", () => {
    const resourceType = "Microsoft.Network/networkInterfaces";
    expect(resourceType.toLowerCase()).toBe(
      "microsoft.network/networkinterfaces",
    );
  });

  it("should detect Public IP Address resource type", () => {
    const resourceType = "Microsoft.Network/publicIPAddresses";
    expect(resourceType.toLowerCase()).toBe(
...
describe("Resource ID Parsing", () => {
  ...
  it("should extract resource name from resource ID", () => {
    ...
    expect(resourceName).toBe("my-vm");
  });
});
