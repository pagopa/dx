...
To inspect the files generated by the Plop generator integration tests, set `KEEP_ARTIFACTS=1` before running the test command.

```bash
KEEP_ARTIFACTS=1 pnpm exec vitest run
```
