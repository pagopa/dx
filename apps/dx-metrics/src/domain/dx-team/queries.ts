/** SQL queries and data transformation logic for the DX Team dashboard. */

import { sql } from "drizzle-orm";

import type { Database } from "../shared/types";
import type { DxTeamDashboardParams, DxTeamDashboardResult } from "./types";

/** Fetches all data for the DX Team dashboard. */
export const fetchDxTeamDashboard = async (
  db: Database,
  params: DxTeamDashboardParams,
