/** Tests SQL result parsing schemas used by domain dashboard queries. */

import { expect, it } from "vitest";

import { versionDriftSummaryRowSchema } from "@/domain/dx-adoption/types";
import {
  dxMemberRowSchema,
  maxDateRowSchema,
  prsByReviewerRowSchema,
} from "@/domain/iac/types";
import {
  reviewDistributionRowSchema,
  reviewMetricValueRowSchema,
} from "@/domain/pull-requests-review/types";
import {
  prCommentsBySizeRowSchema,
  prMetricValueRowSchema,
  slowestPrRowSchema,
} from "@/domain/pull-requests/types";
import {
  moduleSummaryRowSchema,
  releaseStatsRowSchema,
} from "@/domain/releases/types";
import {
  parseSqlRow,
  parseSqlRows,
  sqlDateSchema,
