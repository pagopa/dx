...
title: "DevContainers"
ring: trial
tags: [development, containerization, dx, tool]
---
...
- They can be
  [used with Visual Studio Code](https://code.visualstudio.com/docs/remote/containers),
  allowing developers to open a project in a container with a single click.
