...
The data controller is PagoPA S.p.A., with registered office in Rome, Piazza Colonna n. 370, ZIP - 00187, registration number in the Rome Business Register, Tax Code and VAT number 15376371009. Email: info@pagopa.it.
...
PagoPA S.p.A. has appointed its own Data Protection Officer (DPO), pursuant to art. 37 of the Regulation, who can be contacted at the following addresses:

- email: dpo@pagopa.it
- PEC: dpo@pec.pagopa.it
- address: Via Sardegna n. 38 - 00187, ROME (operational headquarters of the company)
...
Requests for exercising such rights may be addressed to the Controller by writing to: privacy@pagopa.it
