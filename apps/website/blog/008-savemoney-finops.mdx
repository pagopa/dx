...
DX team has built **SaveMoney**, a scientific tool integrated into the DX CLI
that helps teams identify and optimize cloud spending without breaking a sweat.
...
SaveMoney empowers teams to quickly identify orphaned resources across multiple
subscriptions. The metric-based analysis provides confidence to act without fear
of false positives.
