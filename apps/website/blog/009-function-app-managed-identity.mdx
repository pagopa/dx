...
shipped an update to the **Azure Function App Terraform module** that eliminates
...
👉
[**Authenticating APIM to Function Apps with Managed Identity**](https://dx.pagopa.it/docs/azure/integrating-services/apim-function-app-authentication)
