---
title: "Introducing the 'Azure Service Bus Namespace' Terraform Module and Usage
...
[DX guidelines](https://dx.pagopa.it/docs/infrastructure/azure/using-service-bus).
