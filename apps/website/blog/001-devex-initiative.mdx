...
<div class="container">
  <div class="row">
    <div class="col col--6">
      <div class="col-demo">![Complex development process without DevEx tools showing multiple manual steps and scattered documentation](001-images/image-3.png)</div>
    </div>
    <div class="col col--6">
      <div class="col-demo">![Streamlined development process with DevEx tools showing automated workflows and centralized resources](001-images/image-2.png)</div>
    </div>
  </div>
</div>
