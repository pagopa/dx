  ...
  terraform_preapply_job:
    ...
    steps:
      ...
      - name: Terraform pre apply common
        ...
        uses: pagopa/terraform-preapply-azure-action@70c6db53dea31f0ddc65ed43e9b7f013859be64e
        with:
          client_id: ${{ secrets.AZURE_CLIENT_ID }}
          tenant_id: ${{ secrets.AZURE_TENANT_ID }}
          subscription_id: ${{ secrets.AZURE_SUBSCRIPTION_ID }}
  ...
  terraform_apply_job:
    ...
    steps:
      - name: Terraform apply common
        ...
        uses: pagopa/terraform-apply-azure-action@845c8b98c03f6c364e11b755935b4d29a1a46e0d
        with:
          client_id: ${{ secrets.AZURE_CLIENT_ID }}
          tenant_id: ${{ secrets.AZURE_TENANT_ID }}
          subscription_id: ${{ secrets.AZURE_SUBSCRIPTION_ID }}
