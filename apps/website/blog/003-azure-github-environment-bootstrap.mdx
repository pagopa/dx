---
title: "Introducing the 'Azure GitHub Environment Bootstrap' Terraform Module to
...
- the IAM setup of both team and Azure user-assigned managed identities
  following the [latest DevEx framework](/docs/azure/iam/azure-iam)
...
- the IDs of team-specific Entra ID groups as expected by
  [DevEx IAM framework](/docs/azure/iam/azure-iam)
