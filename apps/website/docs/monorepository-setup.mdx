...
Before starting, you should group people in Azure Entra ID.
...
This step is required only if you are setting up a Azure subscription or AWS
...
Each product at PagoPA (IO, SelfCare, etc.) has its own dedicated GitHub App for
the self-hosted GitHub runner. You do not need to ask a
