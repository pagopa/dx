...
[DX GitHub Repository](https://github.com/pagopa/dx/tree/main/apps/providers)
...
the provider in the `apps/providers/*` directory of the main repository (`dx`) are
...
The release workflow is located in the `apps/providers/*/.github/workflows`
