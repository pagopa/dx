...
| `outcome.scope`       | In scope             | Entity signed-agreement upload through the new portal; format/digest verification; persistence of the document; practice transition `REQUEST` → `PENDING`.            | PRD; confirmed                        |
...
| -------- | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------ | ----------- |
| `NFR-01` | Performance                             | Upload handling latency target TBD; a pilot proposal is p95 < 2 s excluding client upload time.                   | Load test (K6 — adopt)                                 | Engineering              | gap / open  |
