...
[here](https://registry.terraform.io/namespaces/pagopa).
...
- `--gh-org`: Optional. The GitHub organization where the module's
  sub-repository will be created. Defaults to `pagopa`.
...
1. Contact DevEx team members in the #team_devex_help channel, to add the new
   repository to:
