...
production in minutes instead of weeks, having fewer decisions to make,less code
to interpret and maintain, onboarding new team members with zero downtime: this
is the goal we set for ourselves with the **Developer Experience
...
- **Optimized development environments:** We share pre-configured and ready to
  use templates because infrastructure should never be an obstacle but a
  resource.
