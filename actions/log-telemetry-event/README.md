...
```jsonc
{"type":"event","name":"BuildCompleted","body":"42 files","exception":false}
{"type":"event","name":"CompilationError","body":"tsc failed","exception":true}
```

Span Markers (child spans):

```jsonc
{"type":"spanStart","span":"build","startSpan":"2026-01-15T09:30:12.123Z"}
{"type":"spanEnd","span":"build","endSpan":"2026-01-15T09:31:05.987Z"}
```
