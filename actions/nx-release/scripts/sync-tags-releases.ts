 ...
 *
 * `listReleases` returns releases newest-first, so releases for the tags in the
 * recovery window sit near the top. Pagination stops when:
 ...
 * up to 20 merged PRs. Returns tag names without the `refs/tags/` prefix.
 */
