...
var require_tunnel$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var events$1 = __require("node:events");
...
var require_util$4 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { StringDecoder } = __require("node:string_decoder");
...
//#endregion
//#region ../../node_modules/.pnpm/zod@4.4.2/node_modules/zod/v4/mini/schemas.js
...
//#endregion
//#region ../../packages/dx-tasks/dist/mask-output.js
...
//#endregion
//#region ../../packages/dx-tasks/dist/run-command.js
...
const payloadSchema = /* @__PURE__ */ object({
	modulePath: (/* @__PURE__ */ string()).check(/* @__PURE__ */ _minLength(1)),
	out: /* @__PURE__ */ optional((/* @__PURE__ */ string()).check(/* @__PURE__ */ _minLength(1))),
	refresh: /* @__PURE__ */ _default(/* @__PURE__ */ boolean(), true),
	verbose: /* @__PURE__ */ _default(/* @__PURE__ */ boolean(), false)
});
const isRunningInCI = () => {
	const ci = process.env.CI;
	return Boolean(ci) && ci !== "false" && ci !== "0";
};
async function terraformPlan({ modulePath, out, refresh = true, verbose = false }) {
	...
	if (result.signal) throw new Error(`terraform plan terminated by signal ${result.signal}`);
	const maskedOutput = maskOutput(result.stdout);
	if (verbose) {
		console.log(maskedOutput);
		return;
	}
	const match = maskedOutput.match(/(?:^.*Terraform will perform the following actions:[\s\S]*|^.*No changes\..*)/m);
	console.log((match && match[0]) ?? "No plan output available.");
}
//#endregion
//#region ../../packages/dx-tasks/dist/default-dispatcher.js
...
const createDefaultTaskDispatcher = () => {
...
const actionInputsSchema = /* @__PURE__ */ object({
	payload: (/* @__PURE__ */ string()).check(/* @__PURE__ */ _minLength(1, "Payload cannot be empty")),
	task: (/* @__PURE__ */ string()).check(/* @__PURE__ */ _minLength(1, "Task name cannot be empty"))
});
const parsePayload = (rawPayload) => {
	try {
		return JSON.parse(rawPayload);
	} catch (error) {
		throw new Error(`Failed to parse action payload as JSON: ${error instanceof Error ? error.message : String(error)}`, { cause: error });
	}
};
async function run() {
	...
	if (!inputsResult.success) throw new Error(prettifyError(inputsResult.error));
