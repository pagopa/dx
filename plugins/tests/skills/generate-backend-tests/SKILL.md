...
- the smallest honest file/layout footprint that still keeps the boundary reusable and understandable
...
- Do not switch to a legacy or alternate SDK/client only to make side effects easier to observe unless the repo already owns that client path.
