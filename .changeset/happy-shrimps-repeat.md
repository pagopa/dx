...
- Add code part for `use_managed_identity` and `storage_account_id` to origins for managed identity authentication with automatic RBAC assignment, currently this feature is behind a flag and not generally available yet
